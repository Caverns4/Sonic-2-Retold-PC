...
var Projectile: PackedScene = preload("res://Entities/Enemies/Projectiles/ScratchProjectile.tscn")
...
@onready var sprite: AnimatedSprite2D = $CluckerSprite
...
func _physics_process(delta: float) -> void:
	var diff: Vector2 = GlobalFunctions.get_orientation_to_player(global_position)
