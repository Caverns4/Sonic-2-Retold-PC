...
## Sound to play when when throwing coconuts. Nothing in the oriignal Sonic 2.
...
var coconut_scene: PackedScene = preload("res://Entities/Enemies/Projectiles/CoconutProjectile.tscn")
