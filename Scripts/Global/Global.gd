...
var nextZone = load("res://Scene/Zones/Emerald Hill Zone Act 1.tscn") # change this to the first level in the game (also set in "reset_values")
...
var themes = [preload("res://Audio/Soundtrack/s2br_Invincible.ogg"),preload("res://Audio/Soundtrack/s2br_SuperSonic.ogg"),preload("res://Audio/Soundtrack/s2br_Result.ogg")]
